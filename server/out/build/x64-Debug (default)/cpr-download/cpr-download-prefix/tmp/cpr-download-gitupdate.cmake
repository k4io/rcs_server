    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/kai/source/repos/server/server/deps/sleepy-discord/deps/cpr'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/kai/source/repos/server/server/deps/sleepy-discord/deps/cpr'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()

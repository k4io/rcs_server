...
if(NOT "C:/Users/kai/source/repos/server/server/build/cpr-download/cpr-download-prefix/tmp/cpr-download-download-repoinfo.txt" IS_NEWER_THAN "C:/Users/kai/source/repos/server/server/build/cpr-download/cpr-download-prefix/src/cpr-download-stamp/cpr-download-download-lastrun.txt")
  if(NOT quiet)
    message(STATUS
      "Avoiding repeated git clone, stamp file is up to date: "
      "'C:/Users/kai/source/repos/server/server/build/cpr-download/cpr-download-prefix/src/cpr-download-stamp/cpr-download-download-lastrun.txt'"
    )
  endif()
  return()
endif()
...
#
execute_process(
  COMMAND ${CMAKE_COMMAND} -E copy "C:/Users/kai/source/repos/server/server/build/cpr-download/cpr-download-prefix/tmp/cpr-download-download-repoinfo.txt" "C:/Users/kai/source/repos/server/server/build/cpr-download/cpr-download-prefix/src/cpr-download-stamp/cpr-download-download-lastrun.txt"
  RESULT_VARIABLE error_code
  ${capture_output}
)
_ep_command_check_result(
  error_code "Failed to copy script-last-run stamp file: 'C:/Users/kai/source/repos/server/server/build/cpr-download/cpr-download-prefix/src/cpr-download-stamp/cpr-download-download-lastrun.txt'"
)

...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      _ep_message_quiet_capture(FATAL_ERROR
        "\nFailed to rebase in: 'C:/Users/kai/source/repos/server/server/deps/sleepy-discord/deps/websocketpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      _ep_accumulate_captured_output()
      _ep_message_quiet_capture(FATAL_ERROR
        "Failed to unstash changes in: 'C:/Users/kai/source/repos/server/server/deps/sleepy-discord/deps/websocketpp'.\n"
        "You will have to resolve the conflicts manually"
      )
    endif()
  endif()
